...
from .style_helper import Style_Helper

@dataclass(frozen=True)
class _TmColors:
    '''Definir cores do tema, se não estiver definido no json usar a default'''
...
@dataclass(frozen=True)
class _TmFonts:
    '''Definir fontes do tema, se não estiver definido no json usar a default'''
    FONTE_LABEL: tuple[str, int] = Style_Helper.get_font("FONTE_LABEL", ("Segoe UI", 10))
